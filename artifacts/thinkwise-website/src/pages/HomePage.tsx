        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl flex items-center justify-between">
          <a href="#home" className="flex items-center gap-0">
            ...
            <div className="flex flex-col gap-0.5 -ml-1.5 lg:-ml-[14px]">
              ...
              <span className="hidden lg:block text-[19px] font-medium tracking-[0.2em] uppercase text-slate-400 pl-1">Make the difference</span>
            </div>
          </a>
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-xl font-semibold text-slate-300 hover:text-white transition-all duration-200 hover:scale-[1.2] active:scale-95 inline-block"
              >
                {link.name}
              </a>
            ))}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <a href="#home" className="flex items-center gap-0">
              ...
              <div className="flex flex-col gap-0.5" style={{ marginLeft: '-9px' }}>
                ...
                {/* Mobile/tablet: words spread to match logo width */}
                <span className="flex lg:hidden justify-between w-full text-[11px] font-medium uppercase text-slate-400">
                  <span>Make</span><span>the</span><span>difference</span>
                </span>
                {/* Desktop: original style */}
                <span className="hidden lg:block text-[11px] font-medium tracking-[0.2em] uppercase text-slate-400 pl-1">Make the difference</span>
              </div>
            </a>
